...
```markdown
[![Ansible Deployment](https://github.com/TheBugYouCantFix/DevOps-Core-Course/actions/workflows/ansible-deploy.yml/badge.svg)](https://github.com/TheBugYouCantFix/DevOps-Core-Course/actions/workflows/ansible-deploy.yml)
```
...
### Key Learnings
Advanced Ansible & CI/CD — Submission
