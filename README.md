...
[![Ansible Deployment](https://github.com/kolsmer/DevOps-Core-Course/actions/workflows/ansible-deploy.yml/badge.svg)](https://github.com/kolsmer/DevOps-Core-Course/actions/workflows/ansible-deploy.yml)
